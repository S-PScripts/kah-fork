local Settings = {
    ["Autorun Commands"] = {"antikick","antiservercrash","antiabuse","antiname","localremoveobby","fixvelocity","runcommand logs","antivoid","antifly"}, -- Commands to run automatically
    ["Default Whitelisted"] = {}, -- People whitelisted by default
    ["Default Banned"] = {}, -- People banned by default [Broken]
    ["Default Softlocked"] = {"794x794","Instlgator","blue20043","Arman2oooo","aonhayhoinon011","KsiPrimeUwu","BarfinOnTheHomeless","InceptionToxic","KyjeuX","surakurd","KohlsH_Angler","Apirlfoolscrasher"},
    ...
    for Y=0,Range do
        for X=Range*-1,Range do
            for Z=Range*-1,Range do
                ...
                if not table.find(AlreadyChecked,CFrame.new(X*10000,Y*10000,Z*10000)) then
                    print("X: "..tostring(X).." / Y: "..tostring(Y).." / Z: "..tostring(Z))
                    table.insert(AlreadyChecked,CFrame.new(X*10000,Y*10000,Z*10000))
                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(X*10000,Y*10000,Z*10000)
...
local gwawg = 0
repeat wait(0.1) gwawg = gwawg + 0.1
    if workspace.Terrain["_Game"].Folder:FindFirstChild("Sound") then
        ...
        if music.IsLoaded and music.SoundId == soundlock then
           ...
           if math.abs(music.TimePosition - gwawg) > 0.2 then
